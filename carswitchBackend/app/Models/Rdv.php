 ...
 * @property string $rdv_date
 * @property string $rdv_time
 * @property string $rdv_type
...
class Rdv extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['car_id', 'admin_id', 'garage_id', 'rdv_date', 'address', 'rdv_time', 'rdv_type', 'created_at', 'updated_at', 'deleted_at'];
